...
```tsx
import { Button, Card, Input, Label, Textarea, cn } from '@upshift-tools/shared-ui'
```

### 3. Use the shared theme
...
/* app-specific styles */
* { @apply border-border; }
body { @apply bg-background text-foreground m-0; }
```

## Exports

- **Components**: `Button`, `Card`, `Input`, `Label`, `Textarea`
