...
import { APP_URLS, Card, CardContent, CardHeader, CardTitle, ToolPageRelatedLinks } from '@upshift-tools/shared-ui';
      ...
      <div className='mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10'>
        ...
        <div className='mt-8 text-sm text-muted-foreground'>
          <p>
            ...
            for how JSON-LD is used in search.
          </p>
        </div>
        <ToolPageRelatedLinks
          relatedTools={[
            { href: APP_URLS.QR_CODE_CREATOR, label: 'QR Code Creator' },
            { href: APP_URLS.IMAGE_OPTIMIZER, label: 'Image Optimizer' },
          ]}
        />
      </div>
    </div>
